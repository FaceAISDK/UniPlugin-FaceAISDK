...
open class ResultJSON (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("ResultJSON", "uni_modules/FaceAI-Search/utssdk/interface.uts", 45, 13)
    }
}
...
val insertFaceSearchFeature: InsertFaceSearchFeature = fun(faceID: String, faceFeature: String, tag: String, group: String, callback: (result: ResultJSON) -> Unit) {
    ...
    if (faceID == null || faceID.trim() == "") {
        ...
        console.error(errorResult.msg, " at uni_modules/FaceAI-Search/utssdk/app-android/index.uts:67")
    ...
    if (faceFeature == null || faceFeature.length != 1024) {
        ...
        console.error(errorResult.msg, " at uni_modules/FaceAI-Search/utssdk/app-android/index.uts:82")
        callback(errorResult)
        return
    }
    try {
        ...
        console.error("insertFaceSearchFeature error: " + e.message, " at uni_modules/FaceAI-Search/utssdk/app-android/index.uts:117")
    ...
    UTSAndroid.onAppActivityResult(fun(requestCode: Int, resultCode: Int, intentAct: Intent?){
        if (requestCode == 10086) {
            if (intentAct != null) {
                ...
                console.log("添加人脸人脸：" + resultJson, " at uni_modules/FaceAI-Search/utssdk/app-android/index.uts:219")
                callback(resultJson)
            } else {
